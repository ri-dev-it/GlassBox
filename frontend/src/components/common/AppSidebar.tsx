...
const navigation = [
  ...
  { group: 'Analytics', links: [{ to: '/analytics', label: 'Credit Analytics', icon: BarChart3 }, { to: '/merchant-risk', label: 'Merchant Risk', icon: Store }, { to: '/portfolio', label: 'Portfolio Overview', icon: BarChart3 }, { to: '/risk-analysis', label: 'Risk Analysis', icon: ShieldAlert }, { to: '/reports', label: 'Reports', icon: FileText }] },
